...
pub async fn abort_catchup(
    ...
    catchpoint: &str,
) -> Result<crate::models::InlineResponse2006, Error<AbortCatchupError>> {
...
) -> Result<crate::models::InlineResponse2008, Error<AddParticipationKeyError>> {
    let local_var_configuration = configuration;
...
pub async fn start_catchup(
    configuration: &configuration::Configuration,
    catchpoint: &str,
) -> Result<crate::models::InlineResponse2005, Error<StartCatchupError>> {
    let local_var_configuration = configuration;
